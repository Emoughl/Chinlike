...
{
    public class SanphammoicapnhatController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create(IDNew main)
        {
            if (Session["Taikhoanadmin"] == null)
                return RedirectToAction("Login", "Admin");
            else
            {
                db.IDNew.InsertOnSubmit(main);
                db.SubmitChanges();

                return RedirectToAction("Index", "Sanphammoicapnhat");
            }
        }
        [HttpGet]
